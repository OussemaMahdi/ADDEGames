 ...
 */
class Image extends \Sce\UserBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sce\\UserBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Sce\\UserBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Sce\\UserBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'Sce\\UserBundle\\Entity\\Image' . "\0" . 'tempFilename', '' . "\0" . 'Sce\\UserBundle\\Entity\\Image' . "\0" . 'mission'];
        }
