 ...
 */
class User extends \Sce\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Sce\\UserBundle\\Entity\\User' . "\0" . 'pseudo', '' . "\0" . 'Sce\\UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'Sce\\UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'Sce\\UserBundle\\Entity\\User' . "\0" . 'jens', '' . "\0" . 'Sce\\UserBundle\\Entity\\User' . "\0" . 'dateInscription', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
